...
//ROTER:1 Get the all notes of user using  GET "api/notes/fetchallnotes". Login required
...
//ROTER:2 Adding a new note using  POST "api/notes/addnote". Login required
router.post(
  "/addnote",
  fetchuser,
  [
